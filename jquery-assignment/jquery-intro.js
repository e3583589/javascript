...
// if it’s December, add a special greeting
if(monthNumber === 11) { // December is 11
    $("#slogan").after("<h3>Happy Holidays!</h3>");
}
// show the special for this month
$("#specials").html(specials[monthNumber]);

// use the month number to get the name from the months array
...
// append the year to the copyright
$("#copy").append(" " + year);
...
// change the tips content for the season
$("#seasontips").html(tips[seasonIndex]);

// change heading and strong colors
$("strong, h1, h2, h3").css("color", seasonColor);

// add a class to the specials div
